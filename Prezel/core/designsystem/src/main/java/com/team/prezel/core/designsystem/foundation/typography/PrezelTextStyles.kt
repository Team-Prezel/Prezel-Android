...
internal object PrezelTextStyles {
    val Title1Medium: PrezelTextStyle = PrezelTextStyle(
        ...
        fontSize = PrezelFontSize.V_500,
        lineHeight = PrezelFontLineHeight.V_500,
        letterSpacing = PrezelFontLetterSpacing.V_500,
    )
    ...
    val Title2Medium: PrezelTextStyle = PrezelTextStyle(
        fontWeight = PrezelFontWeight.MEDIUM,
        fontSize = PrezelFontSize.V_400,
        lineHeight = PrezelFontLineHeight.V_400,
        letterSpacing = PrezelFontLetterSpacing.V_400,
    )
    ...
    val Body1Regular: PrezelTextStyle = PrezelTextStyle(
        ...
        fontSize = PrezelFontSize.V_400,
        lineHeight = PrezelFontLineHeight.V_400,
        letterSpacing = PrezelFontLetterSpacing.V_300,
    )
    ...
    val Body2Regular: PrezelTextStyle = PrezelTextStyle(
        fontWeight = PrezelFontWeight.REGULAR,
        fontSize = PrezelFontSize.V_300,
        lineHeight = PrezelFontLineHeight.V_300,
        letterSpacing = PrezelFontLetterSpacing.V_300,
    )
    ...
    val Body3Regular: PrezelTextStyle = PrezelTextStyle(
        fontWeight = PrezelFontWeight.REGULAR,
        fontSize = PrezelFontSize.V_200,
        lineHeight = PrezelFontLineHeight.V_200,
        letterSpacing = PrezelFontLetterSpacing.V_200,
    )
    ...
    val Caption1Regular: PrezelTextStyle = PrezelTextStyle(
        fontWeight = PrezelFontWeight.REGULAR,
        fontSize = PrezelFontSize.V_200,
        lineHeight = PrezelFontLineHeight.V_150,
        letterSpacing = PrezelFontLetterSpacing.V_200,
    )
    ...
    val Caption2Regular: PrezelTextStyle = PrezelTextStyle(
        fontWeight = PrezelFontWeight.REGULAR,
        fontSize = PrezelFontSize.V_100,
        lineHeight = PrezelFontLineHeight.V_100,
        letterSpacing = PrezelFontLetterSpacing.V_100,
    )
