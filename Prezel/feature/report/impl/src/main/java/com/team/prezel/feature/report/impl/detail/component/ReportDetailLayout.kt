...
@Composable
internal fun ReportDetailLayout(
    appBarTitle: String,
...
@BasicPreview
@Composable
private fun ReportDetailLayoutPreview() {
    PrezelTheme {
        ReportDetailLayout(
            appBarTitle = ReportDetailPreviewData.analysisState.reportDetail.presentationInfo.title,
            headerContent = { headerTitleModifier ->
                ReportHeaderSection(
                    info = ReportDetailPreviewData.analysisState.reportDetail.presentationInfo,
                    titleModifier = headerTitleModifier,
                )
            },
            bodyContent = {
                ReportDetailSections(
                    reportDetail = ReportDetailPreviewData.analysisState.reportDetail,
                    onDeleteClick = { },
