...
internal fun PracticeRecordingAnalysisFailurePage(
    ...
    StatusView(
        title = stringResource(R.string.feature_home_impl_practice_recording_analysis_error_title),
        description = stringResource(R.string.feature_home_impl_practice_recording_analysis_error_description),
        modifier = modifier,
        visual = {
            Image(
        ...
        action = {
            PrezelButton(
                text = stringResource(R.string.feature_home_impl_practice_recording_analysis_retry),
